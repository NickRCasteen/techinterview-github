! function r(s, a, l) {
	...
	1: [function (t, e, n) {
		var l = window.$ = window.jQuery = t("jquery"),
			i = (t("bootstrap-sass"), t("lunr"));
		l(document).ready(function () {
			"use strict";
			var s, a;
			l.getJSON("/lunr.json", function (t) {
				s = i.Index.load(t.index), a = t.store, l("input#search").on("keyup", function () {
					var t = l(this).val(),
						e = s.search(t),
						n = l("ul.searchresults");
					if (0 === e.length) n.hide();
					else {
						for (var i in n.empty(), e) {
							var o = e[i].ref,
								r = '<li><a href="' + o + '">' + a[o].title + "</a></li>";
							n.append(r)
						}
						n.show()
					}
				})
			}), l("form#searchForm").on("submit", function (t) {
				t.preventDefault();
				var e = l("input#sitesearch").val(),
					n = l("input#search").val(),
					i = "https://www.google.com/search?sitesearch=" + e + "&q=" + encodeURIComponent(n);
	...
	2: [function (t, e, n) {
		...
		function (r) {
			...
			s.VERSION = "3.3.7", s.TRANSITION_DURATION = 150, s.prototype.close = function (t) {
				...
				t && t.preventDefault(), i.length || (i = e.closest(".alert")), i.trigger(t = r.Event("close.bs.alert")), t.isDefaultPrevented() || (i.removeClass("in"), r.support.transition && i.hasClass("fade") ? i.one("bsTransitionEnd", o).emulateTransitionEnd(s.TRANSITION_DURATION) : o())
			};
			var t = r.fn.alert;
		...
		function (f) {
			...
			function s(o) {
				return this.each(function () {
					var t = f(this),
						...
						n = f.extend({}, p.DEFAULTS, t.data(), "object" == typeof o && o),
			...
			p.VERSION = "3.3.7", p.TRANSITION_DURATION = 600, p.DEFAULTS = {
				...
				if (this.$element.trigger(l), !l.isDefaultPrevented()) {
					...
					return f.support.transition && this.$element.hasClass("slide") ? (i.addClass(t), i[0].offsetWidth, n.addClass(r), i.addClass(r), n.one("bsTransitionEnd", function () {
			...
			var t = f.fn.carousel;
			f.fn.carousel = s, f.fn.carousel.Constructor = p, f.fn.carousel.noConflict = function () {
				return f.fn.carousel = t, this
			};
			var e = function (t) {
				var e, n = f(this),
					i = f(n.attr("data-target") || (e = n.attr("href")) && e.replace(/.*(?=#[^\s]+$)/, ""));
				if (i.hasClass("carousel")) {
					var o = f.extend({}, i.data(), n.data()),
			...
			v.VERSION = "3.3.7", v.TRANSITION_DURATION = 150, v.DEFAULTS = {
				...
				if (this.hasContent() && this.enabled) {
					...
					if (a) {
						...
						r = "bottom" == r && l.bottom + c > p.bottom ? "top" : "top" == r && l.top - c < p.top ? "bottom" : "right" == r && l.right + u > p.width ? "left" : "left" == r && l.left - u < p.left ? "right" : r, i.removeClass(f).addClass(r)
					}
					var d = this.getCalculatedOffset(r, l, u, c);
				...
				var c = /top|bottom/.test(e),
					f = c ? 2 * u.left - i + a : 2 * u.top - o + l,
					p = c ? "offsetWidth" : "offsetHeight";
				n.offset(t), this.replaceArrow(f, n[0][p], c)
				...
				if (this.$element.trigger(i), !i.isDefaultPrevented()) return n.removeClass("in"), g.support.transition && n.hasClass("fade") ? n.one("bsTransitionEnd", o).emulateTransitionEnd(v.TRANSITION_DURATION) : o(), this.hoverState = null, this
			...
			g.fn.tooltip = function (i) {
				return this.each(function () {
					var t = g(this),
						e = t.data("bs.tooltip"),
						n = "object" == typeof i && i;
					!e && /destroy|hide/.test(i) || (e || t.data("bs.tooltip", e = new v(this, n)), "string" == typeof i && e[i]())
				})
			}, g.fn.tooltip.Constructor = v, g.fn.tooltip.noConflict = function () {
		...
		function (a) {
			...
			s.VERSION = "3.3.7", s.TRANSITION_DURATION = 150, s.prototype.show = function () {
				...
				i.length && o ? i.one("bsTransitionEnd", r).emulateTransitionEnd(s.TRANSITION_DURATION) : r(), i.removeClass("in")
			};
			var t = a.fn.tab;
	...
	3: [function (t, n, e) {
		! function (t, e) {
			...
			function x(t, e, n) {
				var i, o = (e = e || C).createElement("script");
				if (o.text = t, n)
			...
			E.fn = E.prototype = {
				...
				for ("boolean" == typeof s && (u = s, s = arguments[a] || {}, a++), "object" == typeof s || y(s) || (s = {}), a === l && (s = this, a--); a < l; a++)
					if (null != (t = arguments[a]))
						for (e in t) n = s[e], s !== (i = t[e]) && (u && i && (E.isPlainObject(i) || (o = Array.isArray(i))) ? (o ? (o = !1, r = n && Array.isArray(n) ? n : []) : r = n && E.isPlainObject(n) ? n : {}, s[e] = E.extend(u, r, i)) : void 0 !== i && (s[e] = i));
				return s
			}, E.extend({
				...
				isPlainObject: function (t) {
					var e, n;
					return !(!t || "[object Object]" !== r.call(t)) && (!(e = i(t)) || "function" == typeof (n = v.call(e, "constructor") && e.constructor) && s.call(n) === u)
				},
			...
			var d = function (n) {
				var t, d, x, r, o, h, f, g, w, l, u, T, S, s, C, v, a, c, m, E = "sizzle" + 1 * new Date,
					y = n.document,
					k = 0,
					i = 0,
					p = st(),
				...
				try {
					O.apply(e = I.call(y.childNodes), y.childNodes), e[y.childNodes.length].nodeType
				} catch (t) {
					O = {
				...
				function rt(t, e, n, i) {
					...
					if (!i && ((e ? e.ownerDocument || e : y) !== S && T(e), e = e || S, C)) {
						if (11 !== p && (l = Y.exec(t)))
							if (o = l[1]) {
								if (9 === p) {
								...
								if ((o = l[3]) && d.getElementsByClassName && e.getElementsByClassName) return O.apply(n, e.getElementsByClassName(o)), n
							}
						if (d.qsa && !$[t + " "] && (!v || !v.test(t))) {
							if (1 !== p) f = e, c = t;
							else if ("object" !== e.nodeName.toLowerCase()) {
								for ((a = e.getAttribute("id")) ? a = a.replace(et, nt) : e.setAttribute("id", a = E), r = (u = h(t)).length; r--;) u[r] = "#" + a + " " + mt(u[r]);
								c = u.join(","), f = K.test(t) && gt(e.parentNode) || e
							}
							if (c) try {
				...
				for (t in d = rt.support = {}, o = rt.isXML = function (t) {
						var e = t && (t.ownerDocument || t).documentElement;
						return !!e && "HTML" !== e.nodeName
					}, T = rt.setDocument = function (t) {
						var e, n, i = t ? t.ownerDocument || t : y;
						return i !== S && 9 === i.nodeType && i.documentElement && (s = (S = i).documentElement, C = !o(S), y !== S && (n = S.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", it, !1) : n.attachEvent && n.attachEvent("onunload", it)), d.attributes = lt(function (t) {
							return t.className = "i", !t.getAttribute("className")
						}), d.getElementsByTagName = lt(function (t) {
							return t.appendChild(S.createComment("")), !t.getElementsByTagName("*").length
						}), d.getElementsByClassName = G.test(S.getElementsByClassName), d.getById = lt(function (t) {
						...
						}, a = [], v = [], (d.qsa = G.test(S.querySelectorAll)) && (lt(function (t) {
						...
						}), v = v.length && new RegExp(v.join("|")), a = a.length && new RegExp(a.join("|")), e = G.test(s.compareDocumentPosition), m = e || G.test(s.contains) ? function (t, e) {
							...
							return n || (1 & (n = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1) || !d.sortDetached && e.compareDocumentPosition(t) === n ? t === S || t.ownerDocument === y && m(y, t) ? -1 : e === S || e.ownerDocument === y && m(y, e) ? 1 : l ? L(l, t) - L(l, e) : 0 : 4 & n ? -1 : 1)
						} : function (t, e) {
							if (t === e) return u = !0, 0;
							var n, i = 0,
								o = t.parentNode,
								...
								s = [t],
								a = [e];
							if (!o || !r) return t === S ? -1 : e === S ? 1 : o ? -1 : r ? 1 : l ? L(l, t) - L(l, e) : 0;
						...
						if ((t.ownerDocument || t) !== S && T(t), e = e.replace(U, "='$1']"), d.matchesSelector && C && !$[e + " "] && (!a || !a.test(e)) && (!v || !v.test(e))) try {
							var n = c.call(t, e);
							if (n || d.disconnectedMatch || t.document && 11 !== t.document.nodeType) return n
						} catch (t) {}
						return 0 < rt(e, S, null, [t]).length
					}, rt.contains = function (t, e) {
						return (t.ownerDocument || t) !== S && T(t), m(t, e)
						...
						var e, n = [],
							i = 0,
							o = 0;
						if (u = !d.detectDuplicates, l = !d.sortStable && t.slice(0), t.sort(N), u) {
						...
						preFilter: {
							...
							PSEUDO: function (t) {
								var e, n = !t[6] && t[2];
								return Q.CHILD.test(t[0]) ? null : (t[3] ? t[2] = t[4] || t[5] || "" : n && z.test(n) && (e = h(n, !0)) && (e = n.indexOf(")", n.length - e) - n.length) && (t[0] = t[0].slice(0, e), t[2] = n.slice(0, e)), t.slice(0, 3))
							}
						},
						filter: {
							TAG: function (t) {
							...
							ATTR: function (n, i, o) {
								return function (t) {
									var e = rt.attr(t, n);
									return null == e ? "!=" === i : !i || (e += "", "=" === i ? e === o : "!=" === i ? e !== o : "^=" === i ? o && 0 === e.indexOf(o) : "*=" === i ? o && -1 < e.indexOf(o) : "$=" === i ? o && e.slice(-o.length) === o : "~=" === i ? -1 < (" " + e.replace(_, " ") + " ").indexOf(o) : "|=" === i && (e === o || e.slice(0, o.length + 1) === o + "-"))
								}
							},
							CHILD: function (h, t, e, g, v) {
								...
								return 1 === g && 0 === v ? function (t) {
									...
									var i, o, r, s, a, l, u = m !== y ? "nextSibling" : "previousSibling",
										c = t.parentNode,
									...
									if (c) {
										...
										if (l = [y ? c.firstChild : c.lastChild], y && p) {
											for (d = (a = (i = (o = (r = (s = c)[E] || (s[E] = {}))[s.uniqueID] || (r[s.uniqueID] = {}))[h] || [])[0] === k && i[1]) && i[2], s = a && c.childNodes[a]; s = ++a && s && s[u] || (d = a = 0) || l.pop();)
												if (1 === s.nodeType && ++d && s === t) {
													o[h] = [k, a, d];
													break
												}
										} else if (p && (d = a = (i = (o = (r = (s = t)[E] || (s[E] = {}))[s.uniqueID] || (r[s.uniqueID] = {}))[h] || [])[0] === k && i[1]), !1 === d)
											for (;
												(s = ++a && s && s[u] || (d = a = 0) || l.pop()) && ((b ? s.nodeName.toLowerCase() !== f : 1 !== s.nodeType) || !++d || (p && ((o = (r = s[E] || (s[E] = {}))[s.uniqueID] || (r[s.uniqueID] = {}))[h] = [k, d]), s !== t)););
							...
							PSEUDO: function (t, r) {
								...
								return s[E] ? s(r) : 1 < s.length ? (e = [t, t, "", r], x.setFilters.hasOwnProperty(t.toLowerCase()) ? at(function (t, e) {
									for (var n, i = s(t, r), o = i.length; o--;) t[n = L(t, i[o])] = !(e[n] = i[o])
								}) : function (t) {
									return s(t, 0, e)
								}) : s
							}
						...
						pseudos: {
							...
							lang: at(function (n) {
								return V.test(n || "") || rt.error("unsupported lang: " + n), n = n.replace(Z, tt).toLowerCase(),
									function (t) {
										var e;
										do {
							...
							for (; t = t[l];)
								if (1 === t.nodeType || f)
									if (o = (r = t[E] || (t[E] = {}))[t.uniqueID] || (r[t.uniqueID] = {}), u && u === t.nodeName.toLowerCase()) t = t[l] || t;
										...
										if ((i = o[c]) && i[0] === k && i[1] === p) return s[2] = i[2];
				...
				function wt(d, h, g, v, m, t) {
					return v && !v[E] && (v = wt(v)), m && !m[E] && (m = wt(m, t)), at(function (t, e, n, i) {
						var o, r, s, a = [],
							l = [],
							u = e.length,
							c = t || function (t, e, n) {
							...
							f = !d || !t && h ? c : xt(c, a, d, n, i),
							p = g ? m || (t ? d : u || v) ? [] : e : f;
						if (g && g(f, p, n, i), v)
							for (o = xt(p, l), v(o, [], n, i), r = o.length; r--;)(s = o[r]) && (p[l[r]] = !(f[l[r]] = s));
						if (t) {
							if (m || d) {
								if (m) {
									for (o = [], r = p.length; r--;)(s = p[r]) && o.push(f[r] = s);
									m(null, p = [], o, i)
								}
								for (r = p.length; r--;)(s = p[r]) && -1 < (o = m ? L(t, s) : a[r]) && (t[o] = !(e[o] = s))
							}
						} else p = xt(p === e ? p.splice(u, p.length) : p), m ? m(null, e, p, i) : O.apply(e, p)
					})
				}
						...
						if (e = x.relative[t[a].type]) c = [yt(bt(c), e)];
							...
							if ((e = x.filter[t[a].type].apply(null, t[a].matches))[E]) {
								...
								return wt(1 < a && bt(c), 1 < a && mt(t.slice(0, a - 1).concat({
									value: " " === t[a - 2].type ? "*" : ""
								})).replace(M, "$1"), e, a < n && Tt(t.slice(a, n)), n < i && Tt(t = t.slice(n)), n < i && mt(t))
							}
							c.push(e)
						}
					return bt(c)
				}
				return vt.prototype = x.filters = x.pseudos, x.setFilters = new vt, h = rt.tokenize = function (t, e) {
					var n, i, o, r, s, a, l, u = b[t + " "];
					...
					var n, v, m, y, b, i, o = [],
						...
						s = $[t + " "];
					if (!s) {
						for (e || (e = h(t)), n = e.length; n--;)(s = Tt(e[n]))[E] ? o.push(s) : r.push(s);
						(s = $(t, (v = r, y = 0 < (m = o).length, b = 0 < v.length, i = function (t, e, n, i, o) {
							var r, s, a, l = 0,
								u = "0",
								c = t && [],
								f = [],
								...
								g = d.length;
							for (o && (w = e === S || e || o); u !== g && null != (r = d[u]); u++) {
								if (b && r) {
									for (s = 0, e || r.ownerDocument === S || (T(r), n = !C); a = v[s++];)
										if (a(r, e || S, n)) {
											i.push(r);
											break
										}
							...
							if (l += u, y && u !== l) {
								...
								O.apply(i, f), o && !t && 0 < f.length && 1 < l + m.length && rt.uniqueSort(i)
							}
							return o && (k = h, w = p), c
						}, y ? at(i) : i))).selector = t
					}
					...
					if (n = n || [], 1 === c.length) {
						if (2 < (r = c[0] = c[0].slice(0)).length && "ID" === (s = r[0]).type && 9 === e.nodeType && C && x.relative[r[1].type]) {
							if (!(e = (x.find.ID(s.matches[0].replace(Z, tt), e) || [])[0])) return n;
							u && (e = e.parentNode), t = t.slice(r.shift().value.length)
						}
						for (o = Q.needsContext.test(t) ? 0 : r.length; o-- && (s = r[o], !x.relative[a = s.type]);)
							if ((l = x.find[a]) && (i = l(s.matches[0].replace(Z, tt), K.test(r[0].type) && gt(e.parentNode) || e))) {
								if (r.splice(o, 1), !(t = i.length && mt(r))) return O.apply(n, i), n;
								break
							}
					}
					return (u || f(t, c))(i, e, !C, n, !e || K.test(t) && gt(e.parentNode) || e), n
				}, d.sortStable = E.split("").sort(N).join("") === E, d.detectDuplicates = !!u, T(), d.sortDetached = lt(function (t) {
			...
			E.filter = function (t, e, n) {
				...
				is: function (t) {
					return !!A(this, "string" == typeof t && k.test(t) ? E(t) : t || [], !1).length
				}
			});
			var D, j = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
			(E.fn.init = function (t, e, n) {
				...
				if (n = n || D, "string" == typeof t) {
					...
					if (i[1]) {
						if (e = e instanceof E ? e[0] : e, E.merge(this, E.parseHTML(i[1], e && e.nodeType ? e.ownerDocument || e : C, !0)), N.test(i[1]) && E.isPlainObject(e))
			...
			E.fn.extend({
				...
				contents: function (t) {
					return $(t, "iframe") ? t.contentDocument : ($(t, "template") && (t = t.content || t), E.merge([], t.childNodes))
				}
			}, function (i, o) {
				E.fn[i] = function (t, e) {
					var n = E.map(this, o, t);
					return "Until" !== i.slice(-5) && (e = t), e && "string" == typeof e && (n = E.filter(e, n)), 1 < this.length && (I[i] || E.uniqueSort(n), O.test(i) && n.reverse()), this.pushStack(n)
				}
			});
			var P = /[^\x20\t\r\n\f]+/g;
			...
			E.Callbacks = function (i) {
						...
						s = {
							...
							then: function (e, n, i) {
										...
										var n = this,
											...
											t = function () {
												...
												if (!(o < l)) {
													...
													e = t && ("object" == typeof t || "function" == typeof t) && t.then, y(e) ? a ? e.call(t, u(l, r, R, a), u(l, r, q, a)) : (l++, e.call(t, u(l, r, R, a), u(l, r, q, a), u(l, r, R, r.notifyWith))) : (s !== R && (n = void 0, i = [t]), (a || r.resolveWith)(n, i))
												}
											},
											e = a ? t : function () {
												try {
													...
													E.Deferred.exceptionHook && E.Deferred.exceptionHook(t, e.stackTrace), l <= o + 1 && (s !== q && (n = void 0, i = [t]), r.rejectWith(n, i))
												}
											};
								...
								return E.Deferred(function (t) {
									r[0][3].add(u(0, t, y(i) ? i : R, t.notifyWith)), r[1][3].add(u(0, t, y(e) ? e : R)), r[2][3].add(u(0, t, y(n) ? n : q))
								}).promise()
							},
							promise: function (t) {
				...
				when: function (t) {
					...
					if (n <= 1 && (H(t, r.done(s(e)).resolve, r.reject, !n), "pending" === r.state() || y(o[e] && o[e].then))) return r.then();
					for (; e--;) H(o[e], s(e), r.reject);
					return r.promise()
				}
			});
			...
			function M() {
				C.removeEventListener("DOMContentLoaded", M), S.removeEventListener("load", M), E.ready()
			}
			E.fn.ready = function (t) {
				...
				readyWait: 1,
				ready: function (t) {
					(!0 === t ? --E.readyWait : E.isReady) || (E.isReady = !0) !== t && 0 < --E.readyWait || _.resolveWith(C, [E])
				}
			}), E.ready.then = _.then, "complete" === C.readyState || "loading" !== C.readyState && !C.documentElement.doScroll ? S.setTimeout(E.ready) : (C.addEventListener("DOMContentLoaded", M), S.addEventListener("load", M));
			var W = function (t, e, n, i, o, r, s) {
					...
					else if (void 0 !== i && (o = !0, y(i) || (s = !0), u && (s ? (e.call(t, i), e = null) : (u = e, e = function (t, e, n) {
							return u.call(E(t), n)
						})), e))
			...
			function V(t) {
				return t.replace(B, "ms-").replace(U, z)
			}
			var Q = function (t) {
			...
			E.extend({
				...
				data: function (n, t) {
					...
					return "object" == typeof n ? this.each(function () {
						...
						var e;
						if (r && void 0 === t) return void 0 !== (e = G.get(r, n)) ? e : void 0 !== (e = Z(r, n)) ? e : void 0;
						this.each(function () {
							G.set(this, n, t)
						})
			...
			function at(t, e) {
				for (var n, i, o, r, s, a, l, u = [], c = 0, f = t.length; c < f; c++)(i = t[c]).style && (n = i.style.display, e ? ("none" === n && (u[c] = J.get(i, "display") || null, u[c] || (i.style.display = "")), "" === i.style.display && it(i) && (u[c] = (l = s = r = void 0, s = (o = i).ownerDocument, a = o.nodeName, (l = st[a]) || (r = s.body.appendChild(s.createElement(a)), l = E.css(r, "display"), r.parentNode.removeChild(r), "none" === l && (l = "block"), st[a] = l)))) : "none" !== n && (u[c] = "none", J.set(i, "display", n)));
			...
			function pt(t, e) {
				var n;
				return n = void 0 !== t.getElementsByTagName ? t.getElementsByTagName(e || "*") : void 0 !== t.querySelectorAll ? t.querySelectorAll(e || "*") : [], void 0 === e || e && $(t, e) ? E.merge([t], n) : n
			}
			...
			function mt(t, e, n, i, o) {
				for (var r, s, a, l, u, c, f = e.createDocumentFragment(), p = [], d = 0, h = t.length; d < h; d++)
					if ((r = t[d]) || 0 === r)
						if ("object" === w(r)) E.merge(p, r.nodeType ? [r] : r);
						else if (vt.test(r)) {
					for (s = s || f.appendChild(e.createElement("div")), a = (ut.exec(r) || ["", ""])[1].toLowerCase(), l = ft[a] || ft._default, s.innerHTML = l[1] + E.htmlPrefilter(r) + l[2], c = l[0]; c--;) s = s.lastChild;
					E.merge(p, s.childNodes), (s = f.firstChild).textContent = ""
				} else p.push(e.createTextNode(r));
				for (f.textContent = "", d = 0; r = p[d++];)
					if (i && -1 < E.inArray(r, i)) o && o.push(r);
					else if (u = E.contains(r.ownerDocument, r), s = pt(f.appendChild(r), "script"), u && dt(s), n)
					for (c = 0; r = s[c++];) ct.test(r.type || "") && n.push(r);
				return f
			}
			ht = C.createDocumentFragment().appendChild(C.createElement("div")), (gt = C.createElement("input")).setAttribute("type", "radio"), gt.setAttribute("checked", "checked"), gt.setAttribute("name", "t"), ht.appendChild(gt), m.checkClone = ht.cloneNode(!0).cloneNode(!0).lastChild.checked, ht.innerHTML = "<textarea>x</textarea>", m.noCloneChecked = !!ht.cloneNode(!0).lastChild.defaultValue;
			...
			E.event = {
				...
				add: function (e, t, n, i, o) {
					var r, s, a, l, u, c, f, p, d, h, g, v = J.get(e);
					if (v)
						for (n.handler && (n = (r = n).handler, o = r.selector), o && E.find.matchesSelector(yt, o), n.guid || (n.guid = E.guid++), (l = v.events) || (l = v.events = {}), (s = v.handle) || (s = v.handle = function (t) {
								return void 0 !== E && E.event.triggered !== t.type ? E.event.dispatch.apply(e, arguments) : void 0
							}), u = (t = (t || "").match(P) || [""]).length; u--;) d = g = (a = wt.exec(t[u]) || [])[1], h = (a[2] || "").split(".").sort(), d && (f = E.event.special[d] || {}, d = (o ? f.delegateType : f.bindType) || d, f = E.event.special[d] || {}, c = E.extend({
							type: d,
							origType: g,
							data: i,
							handler: n,
							...
							namespace: h.join(".")
						}, r), (p = l[d]) || ((p = l[d] = []).delegateCount = 0, f.setup && !1 !== f.setup.call(e, i, h, s) || e.addEventListener && e.addEventListener(d, s)), f.add && (f.add.call(e, c), c.handler.guid || (c.handler.guid = n.guid)), o ? p.splice(p.delegateCount++, 0, c) : p.push(c), E.event.global[d] = !0)
				},
				remove: function (t, e, n, i, o) {
					var r, s, a, l, u, c, f, p, d, h, g, v = J.hasData(t) && J.get(t);
					if (v && (l = v.events)) {
						for (u = (e = (e || "").match(P) || [""]).length; u--;)
							if (d = g = (a = wt.exec(e[u]) || [])[1], h = (a[2] || "").split(".").sort(), d) {
								for (f = E.event.special[d] || {}, p = l[d = (i ? f.delegateType : f.bindType) || d] || [], a = a[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = r = p.length; r--;) c = p[r], !o && g !== c.origType || n && n.guid !== c.guid || a && !a.test(c.namespace) || i && i !== c.selector && ("**" !== i || !c.selector) || (p.splice(r, 1), c.selector && p.delegateCount--, f.remove && f.remove.call(t, c));
								s && !p.length && (f.teardown && !1 !== f.teardown.call(t, h, v.handle) || E.removeEvent(t, d, v.handle), delete l[d])
							} else
				...
				dispatch: function (t) {
					...
					if (a.delegateTarget = this, !c.preDispatch || !1 !== c.preDispatch.call(this, a)) {
						for (s = E.event.handlers.call(this, a, u), e = 0;
					...
					if (l && u.nodeType && !("click" === t.type && 1 <= t.button))
						for (; u !== this; u = u.parentNode || this)
							if (1 === u.nodeType && ("click" !== t.type || !0 !== u.disabled)) {
								for (r = [], s = {}, n = 0; n < l; n++) void 0 === s[o = (i = e[n]).selector + " "] && (s[o] = i.needsContext ? -1 < E(o, this).index(u) : E.find(o, this, null, [u]).length), s[o] && r.push(i);
								r.length && a.push({
									elem: u,
									handlers: r
								})
			...
			function Dt(t, e) {
				return $(t, "table") && $(11 !== e.nodeType ? e : e.firstChild, "tr") && E(t).children("tbody")[0] || t
			}
			...
			function It(t, e) {
				var n, i, o, r, s, a, l, u;
				if (1 === e.nodeType) {
					if (J.hasData(t) && (r = J.access(t), s = J.set(e, r), u = r.events))
						for (o in delete s.handle, s.events = {}, u)
							for (n = 0, i = u[o].length; n < i; n++) E.event.add(e, o, u[o][n]);
					G.hasData(t) && (a = G.access(t), l = E.extend({}, a), G.set(e, l))
				}
			}
			...
			function Lt(n, i, o, r) {
				...
				var t, e, s, a, l, u, c = 0,
					...
					d = i[0],
					h = y(d);
				if (h || 1 < f && "string" == typeof d && !m.checkClone && Nt.test(d)) return n.each(function (t) {
					var e = n.eq(t);
					h && (i[0] = d.call(this, t, e.html())), Lt(e, i, o, r)
				});
				if (f && (e = (t = mt(i, n[0].ownerDocument, !1, n, r)).firstChild, 1 === t.childNodes.length && (t = e), e || r)) {
					for (a = (s = E.map(pt(t, "script"), jt)).length; c < f; c++) l = t, c !== p && (l = E.clone(l, !0, !0), a && E.merge(s, pt(l, "script"))), o.call(n[c], l, c);
					if (a)
						for (u = s[s.length - 1].ownerDocument, E.map(s, Ot), c = 0; c < a; c++) l = s[c], ct.test(l.type || "") && !J.access(l, "globalEval") && E.contains(u, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? E._evalUrl && E._evalUrl(l.src) : x(l.textContent.replace(At, ""), u, l))
				}
				return n
			}

			function Pt(t, e, n) {
				for (var i, o = e ? E.filter(e, t) : t, r = 0; null != (i = o[r]); r++) n || 1 !== i.nodeType || E.cleanData(pt(i)), i.parentNode && (n && E.contains(i.ownerDocument, i) && dt(pt(i, "script")), i.parentNode.removeChild(i));
				return t
			}
			E.extend({
				...
				clone: function (t, e, n) {
					var i, o, r, s, a, l, u, c = t.cloneNode(!0),
						f = E.contains(t.ownerDocument, t);
					if (!(m.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || E.isXMLDoc(t)))
						for (s = pt(c), i = 0, o = (r = pt(t)).length; i < o; i++) a = r[i], l = s[i], void 0, "input" === (u = l.nodeName.toLowerCase()) && lt.test(a.type) ? l.checked = a.checked : "input" !== u && "textarea" !== u || (l.defaultValue = a.defaultValue);
					if (e)
						if (n)
							for (r = r || pt(t), s = s || pt(c), i = 0, o = r.length; i < o; i++) It(r[i], s[i]);
						else It(t, c);
					return 0 < (s = pt(c, "script")).length && dt(s, !f && pt(t, "script")), c
				},
				...
				html: function (t) {
					return W(this, function (t) {
						...
						if ("string" == typeof t && !$t.test(t) && !ft[(ut.exec(t) || ["", ""])[1].toLowerCase()]) {
							t = E.htmlPrefilter(t);
							try {
			...
			function Ft(t, e, n) {
				...
				return (n = n || qt(t)) && ("" !== (s = n.getPropertyValue(e) || n[e]) || E.contains(t.ownerDocument, t) || (s = E.style(t, e)), !m.pixelBoxStyles() && Rt.test(s) && Ht.test(e) && (i = a.width, o = a.minWidth, r = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = o, a.maxWidth = r)), void 0 !== s ? s + "" : s
			}
			...
			function _t(t, e) {
				...
				function t() {
					if (l) {
						...
						n = "1%" !== t.top, s = 12 === e(t.marginLeft), l.style.right = "60%", r = 36 === e(t.right), i = 36 === e(t.width), l.style.position = "absolute", o = 36 === l.offsetWidth || "absolute", yt.removeChild(a), l = null
					}
				}
			...
			function Jt(t, e, n, i, o, r) {
				...
				for (; s < 4; s += 2) "margin" === n && (l += E.css(t, n + nt[s], !0, o)), i ? ("content" === n && (l -= E.css(t, "padding" + nt[s], !0, o)), "margin" !== n && (l -= E.css(t, "border" + nt[s] + "Width", !0, o))) : (l += E.css(t, "padding" + nt[s], !0, o), "padding" !== n ? l += E.css(t, "border" + nt[s] + "Width", !0, o) : a += E.css(t, "border" + nt[s] + "Width", !0, o));
			...
			function Gt(t, e, n) {
				...
				return s = s && (m.boxSizingReliable() || o === t.style[e]), ("auto" === o || !parseFloat(o) && "inline" === E.css(t, "display", !1, i)) && (o = t["offset" + e[0].toUpperCase() + e.slice(1)], s = !0), (o = parseFloat(o) || 0) + Jt(t, e, n || (r ? "border" : "content"), s, i, o) + "px"
			}
			...
			E.extend({
				...
				style: function (t, e, n, i) {
					if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
						var o, r, s, a = V(e),
							l = Wt.test(e),
							u = t.style;
						if (l || (e = Qt(a)), s = E.cssHooks[e] || E.cssHooks[a], void 0 === n) return s && "get" in s && void 0 !== (o = s.get(t, !1, i)) ? o : u[e];
						"string" === (r = typeof n) && (o = et.exec(n)) && o[1] && (n = rt(t, e, o), r = "number"), null != n && n == n && ("number" === r && (n += o && o[3] || (E.cssNumber[a] ? "" : "px")), m.clearCloneStyle || "" !== n || 0 !== e.indexOf("background") || (u[e] = "inherit"), s && "set" in s && void 0 === (n = s.set(t, n, i)) || (l ? u.setProperty(e, n) : u[e] = n))
					}
				},
				css: function (t, e, n, i) {
					var o, r, s, a = V(e);
					return Wt.test(e) || (e = Qt(a)), (s = E.cssHooks[e] || E.cssHooks[a]) && "get" in s && (o = s.get(t, !0, n)), void 0 === o && (o = Ft(t, e, i)), "normal" === o && e in Ut && (o = Ut[e]), "" === n || n ? (r = parseFloat(o), !0 === n || isFinite(r) ? r || 0 : o) : o
				}
			}), E.each(["height", "width"], function (t, a) {
				E.cssHooks[a] = {
					get: function (t, e, n) {
						if (e) return !Mt.test(E.css(t, "display")) || t.getClientRects().length && t.getBoundingClientRect().width ? Gt(t, a, n) : ot(t, Bt, function () {
							return Gt(t, a, n)
						})
					},
					set: function (t, e, n) {
						var i, o = qt(t),
							...
							s = n && Jt(t, a, n, r, o);
						return r && m.scrollboxSize() === o.position && (s -= Math.ceil(t["offset" + a[0].toUpperCase() + a.slice(1)] - parseFloat(o[a]) - Jt(t, a, "border", !1, o) - .5)), s && (i = et.exec(e)) && "px" !== (i[3] || "px") && (t.style[a] = e, e = E.css(t, a)), Xt(0, e, s)
					}
				}
			}), E.cssHooks.marginLeft = _t(m.reliableMarginLeft, function (t, e) {
				...
				}, "margin" !== o && (E.cssHooks[o + r].set = Xt)
			}), E.fn.extend({
				css: function (t, e) {
					return W(this, function (t, e, n) {
						var i, o, r = {},
							s = 0;
						if (Array.isArray(e)) {
							for (i = qt(t), o = e.length; s < o; s++) r[e[s]] = E.css(t, e[s], !1, i);
							return r
						}
						return void 0 !== n ? E.style(t, e, n) : E.css(t, e)
					}, t, e, 1 < arguments.length)
				}
			}), ((E.Tween = Yt).prototype = {
				constructor: Yt,
				...
				run: function (t) {
					...
					return this.options.duration ? this.pos = e = E.easing[this.easing](t, this.options.duration * t, 0, 1, this.options.duration) : this.pos = e = t, this.now = (this.end - this.start) * e + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), n && n.set ? n.set(this) : Yt.propHooks._default.set(this), this
				}
				...
				_default: "swing"
			}, E.fx = Yt.prototype.init, E.fx.step = {};
			var Kt, Zt, te, ee, ne = /^(?:toggle|show|hide)$/,
				ie = /queueHooks$/;

			function oe() {
				Zt && (!1 === C.hidden && S.requestAnimationFrame ? S.requestAnimationFrame(oe) : S.setTimeout(oe, E.fx.interval), E.fx.tick())
			}
			...
			function le(r, t, e) {
				var n, s, i = 0,
					...
					l = function () {
						if (s) return !1;
						for (var t = Kt || re(), e = Math.max(0, u.startTime + u.duration - t), n = 1 - (e / u.duration || 0), i = 0, o = u.tweens.length; i < o; i++) u.tweens[i].run(n);
				...
				for (! function (t, e) {
						var n, i, o, r, s;
						for (n in t)
							if (o = e[i = V(n)], r = t[n], Array.isArray(r) && (o = r[1], r = t[n] = r[0]), n !== i && (t[i] = r, delete t[n]), (s = E.cssHooks[i]) && "expand" in s)
								for (n in r = s.expand(r), delete t[i], r) n in t || (t[n] = r[n], e[n] = o);
							else e[i] = o
					}(c, u.opts.specialEasing); i < o; i++)
					if (n = le.prefilters[i].call(u, r, c, u.opts)) return y(n.stop) && (E._queueHooks(u.elem, u.opts.queue).stop = n.stop.bind(n)), n;
				return E.map(c, ae, u), y(u.opts.start) && u.opts.start.call(r, u), u.progress(u.opts.progress).done(u.opts.done, u.opts.complete).fail(u.opts.fail).always(u.opts.always), E.fx.timer(E.extend(l, {
					elem: r,
					anim: u,
					queue: u.opts.queue
				})), u
			...
			E.Animation = E.extend(le, {
				...
				prefilters: [function (t, e, n) {
					...
					for (i in n.queue || (null == (s = E._queueHooks(t, "fx")).unqueued && (s.unqueued = 0, a = s.empty.fire, s.empty.fire = function () {
						...
						if (o = e[i], ne.test(o)) {
							...
							d[i] = v && v[i] || E.style(t, i)
						}
					if ((l = !E.isEmptyObject(e)) || !E.isEmptyObject(d))
						for (i in f && 1 === t.nodeType && (n.overflow = [h.overflow, h.overflowX, h.overflowY], null == (u = v && v.display) && (u = J.get(t, "display")), "none" === (c = E.css(t, "display")) && (u ? c = u : (at([t], !0), u = t.style.display || u, c = E.css(t, "display"), at([t]))), ("inline" === c || "inline-block" === c && null != u) && "none" === E.css(t, "float") && (l || (p.done(function () {
								h.display = u
							}), null == u && (c = h.display, u = "none" === c ? "" : c)), h.display = "inline-block")), n.overflow && (h.overflow = "hidden", p.always(function () {
								h.overflow = n.overflow[0], h.overflowX = n.overflow[1], h.overflowY = n.overflow[2]
							})), l = !1, d) l || (v ? "hidden" in v && (g = v.hidden) : v = J.access(t, "fxshow", {
							display: u
						}), r && (v.hidden = !g), g && at([t], !0), p.done(function () {
							for (i in g || at([t]), J.remove(t, "fxshow"), d) E.style(t, i, d[i])
						})), l = ae(g ? v[i] : 0, i, p), i in v || (v[i] = l.start, g && (l.end = l.start, l.start = 0))
				}],
				...
				E.fn[i] = function (t, e, n) {
					return null == t || "boolean" == typeof t ? o.apply(this, arguments) : this.animate(se(i, !0), t, e, n)
				}
			}), E.each({
				slideDown: se("show"),
				slideUp: se("hide"),
			...
			}, te = C.createElement("input"), ee = C.createElement("select").appendChild(C.createElement("option")), te.type = "checkbox", m.checkOn = "" !== te.value, m.optSelected = ee.selected, (te = C.createElement("input")).value = "t", te.type = "radio", m.radioValue = "t" === te.value;
			...
			E.fn.extend({
				...
				addClass: function (e) {
					...
					if (y(e)) return this.each(function (t) {
						E(this).addClass(e.call(this, t, he(this)))
					});
					if ((t = ge(e)).length)
						for (; n = this[l++];)
				...
				removeClass: function (e) {
					var t, n, i, o, r, s, a, l = 0;
					if (y(e)) return this.each(function (t) {
						E(this).removeClass(e.call(this, t, he(this)))
					});
				...
				toggleClass: function (o, e) {
					...
					return "boolean" == typeof e && s ? e ? this.addClass(o) : this.removeClass(o) : y(o) ? this.each(function (t) {
						E(this).toggleClass(o.call(this, t, he(this), e), e)
					}) : this.each(function () {
						var t, e, n, i;
						if (s)
							for (e = 0, n = E(this), i = ge(o); t = i[e++];) n.hasClass(t) ? n.removeClass(t) : n.addClass(t);
						else void 0 !== o && "boolean" !== r || ((t = he(this)) && J.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || !1 === o ? "" : J.get(this, "__className__") || ""))
					})
				},
				hasClass: function (t) {
					var e, n, i = 0;
			...
			E.extend(E.event, {
				trigger: function (t, e, n, i) {
					var o, r, s, a, l, u, c, f, p = [n || C],
						d = v.call(t, "type") ? t.type : t,
						h = v.call(t, "namespace") ? t.namespace.split(".") : [];
					if (r = f = s = n = n || C, 3 !== n.nodeType && 8 !== n.nodeType && !me.test(d + E.event.triggered) && (-1 < d.indexOf(".") && (d = (h = d.split(".")).shift(), h.sort()), l = d.indexOf(":") < 0 && "on" + d, (t = t[E.expando] ? t : new E.Event(d, "object" == typeof t && t)).isTrigger = i ? 2 : 3, t.namespace = h.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = n), e = null == e ? [t] : E.makeArray(e, [t]), c = E.event.special[d] || {}, i || !c.trigger || !1 !== c.trigger.apply(n, e))) {
						if (!i && !c.noBubble && !b(n)) {
							for (a = c.delegateType || d, me.test(a + d) || (r = r.parentNode); r; r = r.parentNode) p.push(r), s = r;
							s === (n.ownerDocument || C) && p.push(s.defaultView || s.parentWindow || S)
						}
						for (o = 0;
							(r = p[o++]) && !t.isPropagationStopped();) f = r, t.type = 1 < o ? a : c.bindType || d, (u = (J.get(r, "events") || {})[t.type] && J.get(r, "handle")) && u.apply(r, e), (u = l && r[l]) && u.apply && Q(r) && (t.result = u.apply(r, e), !1 === t.result && t.preventDefault());
						return t.type = d, i || t.isDefaultPrevented() || c._default && !1 !== c._default.apply(p.pop(), e) || !Q(n) || l && y(n[d]) && !b(n) && ((s = n[l]) && (n[l] = null), E.event.triggered = d, t.isPropagationStopped() && f.addEventListener(d, ye), n[d](), t.isPropagationStopped() && f.removeEventListener(d, ye), E.event.triggered = void 0, s && (n[l] = s)), t.result
					}
				},
				...
				E.event.special[i] = {
					setup: function () {
						var t = this.ownerDocument || this,
							e = J.access(t, i);
						e || t.addEventListener(n, o, !0), J.access(t, i, (e || 0) + 1)
					},
					teardown: function () {
						var t = this.ownerDocument || this,
							e = J.access(t, i) - 1;
						e ? J.access(t, i, e) : (t.removeEventListener(n, o, !0), J.remove(t, i))
					}
				}
			});
			var be = S.location,
			...
			function ke(n, t, i, o) {
				...
				if (Array.isArray(t)) E.each(t, function (t, e) {
					i || Te.test(n) ? o(n, e) : ke(n + "[" + ("object" == typeof e && null != e ? t : "") + "]", e, i, o)
				});
			...
			Re.href = be.href, E.extend({
				...
				ajax: function (t, e) {
					...
					var c, f, p, n, d, i, h, g, o, r, v = E.ajaxSetup({}, e),
						m = v.context || v,
						...
						T = {
							...
							getResponseHeader: function (t) {
								...
								if (h) {
									if (!n)
										for (n = {}; e = De.exec(p);) n[e[1].toLowerCase()] = e[2];
									e = n[t.toLowerCase()]
								}
					...
					function u(t, e, n, i) {
						var o, r, s, a, l, u = e;
						h || (h = !0, d && S.clearTimeout(d), c = void 0, p = i || "", T.readyState = 0 < t ? 4 : 0, o = 200 <= t && t < 300 || 304 === t, n && (a = function (t, e, n) {
						...
						}(v, a, T, o), o ? (v.ifModified && ((l = T.getResponseHeader("Last-Modified")) && (E.lastModified[f] = l), (l = T.getResponseHeader("etag")) && (E.etag[f] = l)), 204 === t || "HEAD" === v.type ? u = "nocontent" : 304 === t ? u = "notmodified" : (u = a.state, r = a.data, o = !(s = a.error))) : (s = u, !t && u || (u = "error", t < 0 && (t = 0))), T.status = t, T.statusText = (e || u) + "", o ? b.resolveWith(m, [r, u, T]) : b.rejectWith(m, [T, u, s]), T.statusCode(w), w = void 0, g && y.trigger(o ? "ajaxSuccess" : "ajaxError", [T, v, o ? r : s]), x.fireWith(m, [T, u]), g && (y.trigger("ajaxComplete", [T, v]), --E.active || E.event.trigger("ajaxStop")))
					}
					return T
				},
			...
			var _e = {
				...
				Me = E.ajaxSettings.xhr();
			m.cors = !!Me && "withCredentials" in Me, m.ajax = Me = !!Me, E.ajaxTransport(function (o) {
				var r, s;
				if (m.cors || Me && !o.crossDomain) return {
					send: function (t, e) {
						var n, i = o.xhr();
						...
						r = function (t) {
							return function () {
								r && (r = s = i.onload = i.onerror = i.onabort = i.ontimeout = i.onreadystatechange = null, "abort" === t ? i.abort() : "error" === t ? "number" != typeof i.status ? e(0, "error") : e(i.status, i.statusText) : e(_e[i.status] || i.status, i.statusText, "text" !== (i.responseType || "text") || "string" != typeof i.responseText ? {
									binary: i.response
								} : {
									text: i.responseText
			...
			E.ajaxSetup({
				...
				if (s || "jsonp" === t.dataTypes[0]) return i = t.jsonpCallback = y(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s ? t[s] = t[s].replace(Ue, "$1" + i) : !1 !== t.jsonp && (t.url += (we.test(t.url) ? "&" : "?") + t.jsonp + "=" + i), t.converters["script json"] = function () {
					return r || E.error(i + " was not called"), r[0]
				}, t.dataTypes[0] = "json", o = S[i], S[i] = function () {
					r = arguments
				}, n.always(function () {
					void 0 === o ? E(S).removeProp(i) : S[i] = o, t[i] && (t.jsonpCallback = e.jsonpCallback, Be.push(i)), r && y(o) && o(r[0]), r = o = void 0
				}), "script"
			}), m.createHTMLDocument = ((We = C.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === We.childNodes.length), E.parseHTML = function (t, e, n) {
				return "string" != typeof t ? [] : ("boolean" == typeof e && (n = e, e = !1), e || (m.createHTMLDocument ? ((i = (e = C.implementation.createHTMLDocument("")).createElement("base")).href = C.location.href, e.head.appendChild(i)) : e = C), r = !n && [], (o = N.exec(t)) ? [e.createElement(o[1])] : (o = mt([t], e, r), r && r.length && E(r).remove(), E.merge([], o.childNodes)));
				var i, o, r
			}, E.fn.load = function (t, e, n) {
				var i, o, r, s = this,
					a = t.indexOf(" ");
				return -1 < a && (i = de(t.slice(a)), t = t.slice(0, a)), y(e) ? (n = e, e = void 0) : e && "object" == typeof e && (o = "POST"), 0 < s.length && E.ajax({
					url: t,
					type: o || "GET",
					dataType: "html",
					data: e
				...
				setOffset: function (t, e, n) {
					var i, o, r, s, a, l, u = E.css(t, "position"),
						c = E(t),
						f = {};
					"static" === u && (t.style.position = "relative"), a = c.offset(), r = E.css(t, "top"), l = E.css(t, "left"), ("absolute" === u || "fixed" === u) && -1 < (r + l).indexOf("auto") ? (s = (i = c.position()).top, o = i.left) : (s = parseFloat(r) || 0, o = parseFloat(l) || 0), y(e) && (e = e.call(t, n, E.extend({}, a))), null != e.top && (f.top = e.top - a.top + s), null != e.left && (f.left = e.left - a.left + o), "using" in e ? e.using.call(t, f) : c.css(f)
				}
			}, E.fn.extend({
				offset: function (e) {
				...
				E.cssHooks[n] = _t(m.pixelPosition, function (t, e) {
					if (e) return e = Ft(t, n), Rt.test(e) ? E(t).position()[n] + "px" : e
				})
			}), E.each({
				Height: "height",
				Width: "width"
			...
			}, E.isArray = Array.isArray, E.parseJSON = JSON.parse, E.nodeName = $, E.isFunction = y, E.isWindow = b, E.camelCase = V, E.type = w, E.now = Date.now, E.isNumeric = function (t) {
				var e = E.type(t);
			...
			return E.noConflict = function (t) {
				return S.$ === E && (S.$ = Ve), t && S.jQuery === E && (S.jQuery = ze), E
			}, t || (S.jQuery = S.$ = E), E
		})
	}, {}],
	4: [function (t, r, s) {
		! function () {
			var e, u, c, t, n, f, p, d, h, g, v, m, y, b, x, w, T, S, C, E, k, $, N, A, D, i, o, j = function (t) {
				var e = new j.Index;
				return e.pipeline.add(j.trimmer, j.stopWordFilter, j.stemmer), t && t.call(e, e), e
			};
			j.version = "0.6.0", j.utils = {}, j.utils.warn = (e = this, function (t) {
				e.console && console.warn && console.warn(t)
			}), j.utils.asString = function (t) {
			...
			}, j.EventEmitter.prototype.removeListener = function (t, e) {
				if (this.hasHandler(t)) {
					var n = this.events[t].indexOf(e);
					this.events[t].splice(n, 1), this.events[t].length || delete this.events[t]
				}
			}, j.EventEmitter.prototype.emit = function (t) {
				if (this.hasHandler(t)) {
			...
			}, j.EventEmitter.prototype.hasHandler = function (t) {
				return t in this.events
			}, j.tokenizer = function (t) {
				return arguments.length && null != t && null != t ? Array.isArray(t) ? t.map(function (t) {
					return j.utils.asString(t).toLowerCase()
				}) : t.toString().trim().toLowerCase().split(j.tokenizer.seperator) : []
			}, j.tokenizer.seperator = /[\s\-]+/, j.Pipeline = function () {
				this._stack = []
			}, j.Pipeline.registeredFunctions = {}, j.Pipeline.registerFunction = function (t, e) {
				e in this.registeredFunctions && j.utils.warn("Overwriting existing registered function: " + e), t.label = e, j.Pipeline.registeredFunctions[t.label] = t
			}, j.Pipeline.warnIfFunctionNotRegistered = function (t) {
				t.label && t.label in this.registeredFunctions || j.utils.warn("Function is not registered with pipeline. This may cause problems when serialising the index.\n", t)
			}, j.Pipeline.load = function (t) {
				var n = new j.Pipeline;
				return t.forEach(function (t) {
					var e = j.Pipeline.registeredFunctions[t];
				...
				Array.prototype.slice.call(arguments).forEach(function (t) {
					j.Pipeline.warnIfFunctionNotRegistered(t), this._stack.push(t)
				}, this)
			}, j.Pipeline.prototype.after = function (t, e) {
				j.Pipeline.warnIfFunctionNotRegistered(e);
				var n = this._stack.indexOf(t);
				if (-1 == n) throw new Error("Cannot find existingFn");
				n += 1, this._stack.splice(n, 0, e)
			}, j.Pipeline.prototype.before = function (t, e) {
				j.Pipeline.warnIfFunctionNotRegistered(e);
				var n = this._stack.indexOf(t);
				if (-1 == n) throw new Error("Cannot find existingFn");
				this._stack.splice(n, 0, e)
			}, j.Pipeline.prototype.remove = function (t) {
				var e = this._stack.indexOf(t); - 1 != e && this._stack.splice(e, 1)
			}, j.Pipeline.prototype.run = function (t) {
				for (var e = [], n = t.length, i = this._stack.length, o = 0; o < n; o++) {
					for (var r = t[o], s = 0; s < i && (void 0 !== (r = this._stack[s](r, o, t)) && "" !== r); s++);
					void 0 !== r && "" !== r && e.push(r)
				}
				return e
				...
				return this._stack.map(function (t) {
					return j.Pipeline.warnIfFunctionNotRegistered(t), t.label
				})
			}, j.Vector = function () {
				this._magnitude = null, this.list = void 0, this.length = 0
			}, j.Vector.Node = function (t, e, n) {
				this.idx = t, this.val = e, this.next = n
			}, j.Vector.prototype.insert = function (t, e) {
				this._magnitude = void 0;
				var n = this.list;
				if (!n) return this.list = new j.Vector.Node(t, e, n), this.length++;
				if (t < n.idx) return this.list = new j.Vector.Node(t, e, n), this.length++;
				for (var i = n, o = n.next; null != o;) {
					if (t < o.idx) return i.next = new j.Vector.Node(t, e, o), this.length++;
					o = (i = o).next
				}
				return i.next = new j.Vector.Node(t, e, o), this.length++
			}, j.Vector.prototype.magnitude = function () {
				if (this._magnitude) return this._magnitude;
				for (var t, e = this.list, n = 0; e;) n += (t = e.val) * t, e = e.next;
				return this._magnitude = Math.sqrt(n)
			}, j.Vector.prototype.dot = function (t) {
				for (var e = this.list, n = t.list, i = 0; e && n;) e.idx < n.idx ? e = e.next : (e.idx > n.idx || (i += e.val * n.val, e = e.next), n = n.next);
				return i
			}, j.Vector.prototype.similarity = function (t) {
				return this.dot(t) / (this.magnitude() * t.magnitude())
			}, j.SortedSet = function () {
				this.length = 0, this.elements = []
			}, j.SortedSet.load = function (t) {
				var e = new this;
			...
			}, j.SortedSet.prototype.map = function (t, e) {
				return this.elements.map(t, e)
			}, j.SortedSet.prototype.forEach = function (t, e) {
				return this.elements.forEach(t, e)
			}, j.SortedSet.prototype.indexOf = function (t) {
				for (var e = 0, n = this.elements.length, i = n - e, o = e + Math.floor(i / 2), r = this.elements[o]; 1 < i;) {
					if (r === t) return o;
					r < t && (e = o), t < r && (n = o), i = n - e, o = e + Math.floor(i / 2), r = this.elements[o]
				}
				return r === t ? o : -1
			}, j.SortedSet.prototype.locationFor = function (t) {
				for (var e = 0, n = this.elements.length, i = n - e, o = e + Math.floor(i / 2), r = this.elements[o]; 1 < i;) r < t && (e = o), t < r && (n = o), i = n - e, o = e + Math.floor(i / 2), r = this.elements[o];
				return t < r ? o : r < t ? o + 1 : void 0
			}, j.SortedSet.prototype.intersect = function (t) {
				for (var e = new j.SortedSet, n = 0, i = 0, o = this.length, r = t.length, s = this.elements, a = t.elements; !(o - 1 < n || r - 1 < i);) s[n] !== a[i] ? s[n] < a[i] ? n++ : s[n] > a[i] && i++ : (e.add(s[n]), n++, i++);
				return e
			}, j.SortedSet.prototype.clone = function () {
				var t = new j.SortedSet;
				return t.elements = this.toArray(), t.length = t.elements.length, t
			}, j.SortedSet.prototype.union = function (t) {
				var e, n, i;
				return this.length >= t.length ? (e = this, n = t) : (e = t, n = this), (i = e.clone()).add.apply(i, n.toArray()), i
			}, j.SortedSet.prototype.toJSON = function () {
				return this.toArray()
			}, j.Index = function () {
				this._fields = [], this._ref = "id", this.pipeline = new j.Pipeline, this.documentStore = new j.Store, this.tokenStore = new j.TokenStore, this.corpusTokens = new j.SortedSet, this.eventEmitter = new j.EventEmitter, this._idfCache = {}, this.on("add", "remove", "update", function () {
					this._idfCache = {}
				}.bind(this))
			}, j.Index.prototype.on = function () {
				var t = Array.prototype.slice.call(arguments);
				return this.eventEmitter.addListener.apply(this.eventEmitter, t)
			}, j.Index.prototype.off = function (t, e) {
				return this.eventEmitter.removeListener(t, e)
			}, j.Index.load = function (t) {
				t.version !== j.version && j.utils.warn("version mismatch: current " + j.version + " importing " + t.version);
				var e = new this;
				return e._fields = t.fields, e._ref = t.ref, e.documentStore = j.Store.load(t.documentStore), e.tokenStore = j.TokenStore.load(t.tokenStore), e.corpusTokens = j.SortedSet.load(t.corpusTokens), e.pipeline = j.Pipeline.load(t.pipeline), e
			}, j.Index.prototype.field = function (t, e) {
				var n = {
					name: t,
					boost: (e = e || {}).boost || 1
				};
				return this._fields.push(n), this
			}, j.Index.prototype.ref = function (t) {
				return this._ref = t, this
			}, j.Index.prototype.add = function (n, t) {
				var i = {},
					o = new j.SortedSet,
					e = n[this._ref];
				t = void 0 === t || t;
				this._fields.forEach(function (t) {
					var e = this.pipeline.run(j.tokenizer(n[t.name]));
					i[t.name] = e, j.SortedSet.prototype.add.apply(o, e)
				}, this), this.documentStore.set(e, o), j.SortedSet.prototype.add.apply(this.corpusTokens, o.toArray());
				for (var r = 0; r < o.length; r++) {
					var s = o.elements[r],
						a = this._fields.reduce(function (t, e) {
			...
			}, j.Index.prototype.remove = function (t, e) {
				var n = t[this._ref];
				e = void 0 === e || e;
			...
			}, j.Index.prototype.update = function (t, e) {
				e = void 0 === e || e;
				this.remove(t, !1), this.add(t, !1), e && this.eventEmitter.emit("update", t, this)
			}, j.Index.prototype.idf = function (t) {
				var e = "@" + t;
				if (Object.prototype.hasOwnProperty.call(this._idfCache, e)) return this._idfCache[e];
				var n = this.tokenStore.count(t),
					i = 1;
				return 0 < n && (i = 1 + Math.log(this.documentStore.length / n)), this._idfCache[e] = i
			}, j.Index.prototype.search = function (t) {
				var e = this.pipeline.run(j.tokenizer(t)),
					h = new j.Vector,
					i = [],
				...
				}, this) ? (e.forEach(function (f, t, e) {
					var p = 1 / e.length * this._fields.length * o,
						d = this,
						n = this.tokenStore.expand(f).reduce(function (t, e) {
							var n = d.corpusTokens.indexOf(e),
								i = d.idf(e),
								o = 1,
								r = new j.SortedSet;
							if (e !== f) {
								var s = Math.max(3, e.length - f.length);
								o = 1 / Math.log(s)
							} - 1 < n && h.insert(n, p * i * o);
							for (var a = d.tokenStore.get(e), l = Object.keys(a), u = l.length, c = 0; c < u; c++) r.add(a[l[c]].ref);
							return t.union(r)
						}, new j.SortedSet);
					i.push(n)
				}, this), i.reduce(function (t, e) {
					return t.intersect(e)
				}).map(function (t) {
					return {
						ref: t,
						score: h.similarity(this.documentVector(t))
					}
				}, this).sort(function (t, e) {
					return e.score - t.score
				})) : []
			}, j.Index.prototype.documentVector = function (t) {
				for (var e = this.documentStore.get(t), n = e.length, i = new j.Vector, o = 0; o < n; o++) {
					var r = e.elements[o],
						s = this.tokenStore.get(r)[t].tf,
						a = this.idf(r);
			...
			}, j.Index.prototype.use = function (t) {
				var e = Array.prototype.slice.call(arguments, 1);
				...
				var t = new this;
				return t.length = n.length, t.store = Object.keys(n.store).reduce(function (t, e) {
					return t[e] = j.SortedSet.load(n.store[e]), t
				}, {}), t
			}, j.Store.prototype.set = function (t, e) {
				this.has(t) || this.length++, this.store[t] = e
			}, j.Store.prototype.get = function (t) {
				return this.store[t]
			}, j.Store.prototype.has = function (t) {
				return t in this.store
			}, j.Store.prototype.remove = function (t) {
				...
				ful: "",
				ness: ""
			}, t = "[aeiouy]", n = "[^aeiou][^aeiouy]*", f = new RegExp("^([^aeiou][^aeiouy]*)?[aeiouy][aeiou]*[^aeiou][^aeiouy]*"), p = new RegExp("^([^aeiou][^aeiouy]*)?[aeiouy][aeiou]*[^aeiou][^aeiouy]*[aeiouy][aeiou]*[^aeiou][^aeiouy]*"), d = new RegExp("^([^aeiou][^aeiouy]*)?[aeiouy][aeiou]*[^aeiou][^aeiouy]*([aeiouy][aeiou]*)?$"), h = new RegExp("^([^aeiou][^aeiouy]*)?[aeiouy]"), g = /^(.+?)(ss|i)es$/, v = /^(.+?)([^s])s$/, m = /^(.+?)eed$/, y = /^(.+?)(ed|ing)$/, b = /.$/, x = /(at|bl|iz)$/, w = new RegExp("([^aeiouylsz])\\1$"), T = new RegExp("^" + n + t + "[^aeiouwxy]$"), S = /^(.+?[^aeiou])y$/, C = /^(.+?)(ational|tional|enci|anci|izer|bli|alli|entli|eli|ousli|ization|ation|ator|alism|iveness|fulness|ousness|aliti|iviti|biliti|logi)$/, E = /^(.+?)(icate|ative|alize|iciti|ical|ful|ness)$/, k = /^(.+?)(al|ance|ence|er|ic|able|ible|ant|ement|ment|ent|ou|ism|ate|iti|ous|ive|ize)$/, $ = /^(.+?)(s|t)(ion)$/, N = /^(.+?)e$/, A = /ll$/, D = new RegExp("^" + n + t + "[^aeiouwxy]$"), function (t) {
				var e, n, i, o, r, s, a;
				if (t.length < 3) return t;
				if ("y" == (i = t.substr(0, 1)) && (t = i.toUpperCase() + t.substr(1)), r = v, (o = g).test(t) ? t = t.replace(o, "$1$2") : r.test(t) && (t = t.replace(r, "$1$2")), r = y, (o = m).test(t)) {
					var l = o.exec(t);
					(o = f).test(l[1]) && (o = b, t = t.replace(o, ""))
				} else r.test(t) && (e = (l = r.exec(t))[1], (r = h).test(e) && (s = w, a = T, (r = x).test(t = e) ? t += "e" : s.test(t) ? (o = b, t = t.replace(o, "")) : a.test(t) && (t += "e")));
				return (o = S).test(t) && (t = (e = (l = o.exec(t))[1]) + "i"), (o = C).test(t) && (e = (l = o.exec(t))[1], n = l[2], (o = f).test(e) && (t = e + u[n])), (o = E).test(t) && (e = (l = o.exec(t))[1], n = l[2], (o = f).test(e) && (t = e + c[n])), r = $, (o = k).test(t) ? (e = (l = o.exec(t))[1], (o = p).test(e) && (t = e)) : r.test(t) && (e = (l = r.exec(t))[1] + l[2], (r = p).test(e) && (t = e)), (o = N).test(t) && (e = (l = o.exec(t))[1], r = d, s = D, ((o = p).test(e) || r.test(e) && !s.test(e)) && (t = e)), r = p, (o = A).test(t) && r.test(t) && (o = b, t = t.replace(o, "")), "y" == i && (t = i.toLowerCase() + t.substr(1)), t
			}), j.Pipeline.registerFunction(j.stemmer, "stemmer"), j.generateStopWordFilter = function (t) {
			...
			}, j.stopWordFilter = j.generateStopWordFilter(["a", "able", "about", "across", "after", "all", "almost", "also", "am", "among", "an", "and", "any", "are", "as", "at", "be", "because", "been", "but", "by", "can", "cannot", "could", "dear", "did", "do", "does", "either", "else", "ever", "every", "for", "from", "get", "got", "had", "has", "have", "he", "her", "hers", "him", "his", "how", "however", "i", "if", "in", "into", "is", "it", "its", "just", "least", "let", "like", "likely", "may", "me", "might", "most", "must", "my", "neither", "no", "nor", "not", "of", "off", "often", "on", "only", "or", "other", "our", "own", "rather", "said", "say", "says", "she", "should", "since", "so", "some", "than", "that", "the", "their", "them", "then", "there", "these", "they", "this", "tis", "to", "too", "twas", "us", "wants", "was", "we", "were", "what", "when", "where", "which", "while", "who", "whom", "why", "will", "with", "would", "yet", "you", "your"]), j.Pipeline.registerFunction(j.stopWordFilter, "stopWordFilter"), j.trimmer = function (t) {
				return t.replace(/^\W+/, "").replace(/\W+$/, "")
			}, j.Pipeline.registerFunction(j.trimmer, "trimmer"), j.TokenStore = function () {
				this.root = {
					docs: {}
				}, this.length = 0
			}, j.TokenStore.load = function (t) {
				var e = new this;
				return e.root = t.root, e.length = t.length, e
			}, j.TokenStore.prototype.add = function (t, e, n) {
				n = n || this.root;
				var i = t.charAt(0),
					o = t.slice(1);
				return i in n || (n[i] = {
			...
			}, j.TokenStore.prototype.has = function (t) {
				if (!t) return !1;
				...
				return !0
			}, j.TokenStore.prototype.getNode = function (t) {
				if (!t) return {};
				for (var e = this.root, n = 0; n < t.length; n++) {
				...
				return e
			}, j.TokenStore.prototype.get = function (t, e) {
				return this.getNode(t, e).docs || {}
			}, j.TokenStore.prototype.count = function (t, e) {
				return Object.keys(this.get(t, e)).length
			}, j.TokenStore.prototype.remove = function (t, e) {
				if (t) {
			...
			}, j.TokenStore.prototype.expand = function (e, n) {
				...
				return j
			}, "function" == typeof define && define.amd ? define(o) : "object" == typeof s ? r.exports = o() : i.lunr = o()
		}()
	}, {}]
}, {}, [1]);